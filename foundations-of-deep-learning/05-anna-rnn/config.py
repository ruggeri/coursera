...
CONFIG_NAME = "2_LAYER_MODE"

if CONFIG_NAME == "TEST_MODE":
...
elif CONFIG_NAME == "2_LAYER_MODE":
    # These settings worked pretty well to train an ~60% accuracy
    # model of Anna Karenina.
    BATCH_SIZE = 40
    BURN_IN_LETTERS = 128
