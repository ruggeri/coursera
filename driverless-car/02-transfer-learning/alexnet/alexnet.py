...
# This is the work of someone else (I forget who) who ported over the
# architecture of AlexNet. Note how the convolution layers sometimes
...
def conv(input,
    ...
    if tf.__version__ < "1.0.0":
        if group == 1:
            ...
            output_groups = [convolve(i, k) for i, k
                             in zip(input_groups, kernel_groups)]
