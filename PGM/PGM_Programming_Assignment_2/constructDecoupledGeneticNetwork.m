...
% assumes that, in the pedigree, either both parents are specified or
% neither parent is specified.
...
% 1.  The first n variables should be the gene copy 1 variables and
...
% has gene copy 1 variable number i.  If the parents are specified,
% then gene copy 1 is the copy inherited from
% pedigree.names{pedigree.parents(i, 1)}.

% 2.  The next n variables should be the gene copy 2 variables and
% should be numbered according to the index of the corresponding
% person in pedigree.names; the ith person with name pedigree.names{i}
% has gene copy 2 variable number n+i.  If the parents are specified,
% then gene copy 2 is the copy inherited from pedigree.parents(i, 2).

% 3.  The final n variables should be the phenotype variables and
% should be numbered according to the index of the corresponding
% person in pedigree.names; the ith person with name pedigree.names{i}
% has phenotype variable number 2n+i.
...
%   alphaList: m x 1 vector of alphas for different genotypes, where m
%   is the number of genotypes -- the alpha value for a genotype is
%   the probability that a person with that genotype will have the
%   physical trait
% Output:
...
% factor for the CPD at each of 2 parental copies of the gene and a
% factor for the CPD at the phenotype Note that the order of the
