...
for i=1:length(genotypeFactor.val)
  a1 = genotypesToAlleles(i, 1);
  a2 = genotypesToAlleles(i, 2);
  if a1 == a2
    genotypeFactor.val(i) = alleleFreqs(a1) * alleleFreqs(a1);
  else
    genotypeFactor.val(i) = 2*alleleFreqs(a1)*alleleFreqs(a2);
  end
end
